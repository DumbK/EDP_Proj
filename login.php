...
<head>
    ...
    <title>BSIT Payment System</title>
    ...
    <div class="container">
         ...
         <div class="row ">
                ...
                <div class="col-md-5 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                            ...
                            <div class="panel-body" style="background-color: #E2E2E2; margin-top:200px; border:solid 3px #0e0e0e;">
							  <h3 class="myhead">BSIT Payment System</h3>
